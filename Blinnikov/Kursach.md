...
1. [Глава 1](#stage1)
   ...
   - [Цели и задачи](#target_tasks)
   - [Входные данные](#import_data)
      - [Справочная информация](#reference)
      - [Операционные данные](#Operational_data)
      - [Административные данные](#Administrative_data)
      - [Параметры и данные сессии](#Session_parameters_and_data)
   - [Перечень выходных данных](#export_data)
      - [Операционные документы](#Operational_documents)
      - [Отчетные формы](#Reporting_forms)
      - [Справочники и выборки](#Reference_books_and_samples)
      - [Системные данные](#system_data)
   - [Ограничения предметной области](#Subject_area_limitations)
      - [Функциональные ограничения](#Functional_limitations)
      - [Технические Ограничения](#Technical_limitations)
      - [Ограничения по интеграции](#Integration_restrictions)
      - [Административные ограничения](#Administrative_restrictions)
   - [Взаимодействие с другими программами](#Interaction_with_other_programs)
      - [Системное программное обеспечение](#System_software)
      - [Прикладное программное обеспечение](#Application_software)
      - [Внешние системы и API](#External_systems_and_API)
...
#<a id="#stage1"><p align="center"> Глава 1 </p>
...
###<a id="#target_tasks">Цель проекта:
...
##<a id="#import_data">Перечень входных данных
...
###<a id="#reference">1. Справочная информация (нормативные данные)
...
###<a id="#Operational_data">2. Операционные данные (транзакционные)
...
###<a id="#Administrative_data">3. Административные данные
...
###<a id="#Session_parameters_and_data">4. Параметры и данные сессии
...
##<a id="#export_data">1.3. Перечень выходных данных
...
###<a id="#Operational_documents">1. Операционные документы (для клиентов и внутреннего учета)
...
###<a id="#Reporting_forms">2. Отчетные формы (для внутреннего анализа)
...
###<a id="#Reference_books_and_samples">3. Справочники и выборки (для работы в системе)
#### 3.1. Список клиентов
...
###<a id="#system_data">4. Системные данные
...
##<a id="#Subject_area_limitations">1.4. Ограничения предметной области
...
###<a id="#Functional limitations">1. Функциональные ограничения
...
###<a id="#Technical_limitations">2. Технические ограничения
...
###<a id="#Integration_restrictions">3. Ограничения по интеграции
...
###<a id="#Administrative_restrictions">4. Административные ограничения
...
##<a id="#Interaction_with_other_programs">1.5. Взаимодействие с другими программами
...
###<a id="#System_software">1. Системное программное обеспечение (обязательное)
...
###<a id="#Application_software">2. Прикладное программное обеспечение (опциональное/вспомогательное)
#### 2.1. Офисные пакеты:
...
###<a id="#External_systems_and_API">3. Внешние системы и API (потенциальное взаимодействие)
