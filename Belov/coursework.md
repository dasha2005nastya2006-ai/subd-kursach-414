...
#### <a id="ps3">3.	 **Кластеризация данных и организация таблиц**</a>
...
#### <a id="ps4">4.	 **Архитектура хранения и оптимизация процессов**</a>
...
#### <a id="ps5">5.	**Политика обеспечения целостности данных**</a>
...
#### <a id="ps6">6.	**Параметры хранения и резервное копирование.**</a>
...
#### <a id="ps7">7.	**SQL-код создания таблиц с физической структурой для PostgreSQL**</a>
...
-	PostgresPro https://postgrespro.ru/docs/postgresql
-	Функции и процедуры: изучаем PostgreSQL https://sql-ex.ru/blogs/?/Funkcii_i_procedury_izuchaem_PostgreSQL_vmeste_s_Grant_Fritchey.html
