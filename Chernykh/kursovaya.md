...
1. **Анализировать предметную область контроля успеваемости школьников**
2. **Проектировать структуру базы данных.**
3. **Выбрать и обосновать систему управления базами данных (СУБД)**
4. **Реализовать структуру базы данных на выбранной СУБД**
5. **Заполнить базу данных тестовыми данными**
6. **Разработать и протестировать приложение с использованием Python**
7. **Осуществить тестирование базы данных**
