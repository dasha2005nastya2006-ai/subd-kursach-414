...
<ol>
    ...
    <li><strong>Серверы электронной почты (SMTP):</strong> Рассылка автоматических и массовых уведомлений, подтверждений, напоминаний гостям, владельцам и сотрудникам. Использование почтовых сервисов (Mailgun, SendGrid) или собственного SMTP.</li>
