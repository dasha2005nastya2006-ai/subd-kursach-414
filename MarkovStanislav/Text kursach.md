...
<p>
Для повышения производительности запросов в базе данных были созданы индексы по
наиболее часто используемым полям, таким как идентификатор пользователя и дата
операции.
</p>
...
<code>postgres</code>, обладающая полным доступом ко всем объектам базы данных, и прикладная роль
